/* empty css                                 */
import { e as createComponent, m as maybeRenderHead, r as renderTemplate, k as renderComponent, l as renderScript } from '../chunks/astro/server_BTqpNUbh.mjs';
...
}, "E:/smileyapp/src/components/OnboardingModal.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "AppShell", $$AppShell, {})} ${renderComponent($$result2, "OnboardingModal", $$OnboardingModal, {})} ` })} ${renderScript($$result, "E:/smileyapp/src/pages/index.astro?astro&type=script&index=0&lang.ts")}`;
}, "E:/smileyapp/src/pages/index.astro", void 0);

const $$file = "E:/smileyapp/src/pages/index.astro";
const $$url = "";
